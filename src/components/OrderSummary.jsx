...
const OrderSummary = () => {
  const { total, subtotal, coupon, isCouponApplied, cart, applyCoupon } =
    useCartStore();
  ...
  // Only show savings if the coupon is applied
  const savings = isCouponApplied ? validSubtotal - validTotal : 0;
  ...
  const handlePayment = () => {
    navigate("/purchase-success"); // Navigate to the Purchase Success page
  };
    ...
    >
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          {/* Displaying the correct original price */}
